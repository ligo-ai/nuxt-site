  ...
  data() {
    return {
      slides: [
        {
          quote:
            'We’ve always been intensely focused on enabling our partners and customers to improve business outcomes. The addition of Security and Privacy will complement our mission of decentralizing our network.',
          quotedBy: 'Manohar K',
        ...
        {
          quote:
            'We are very excited to start working with Ligo AI to improve the developer experience of the crowd building the DIA ecosystem by offering a number of privacy and security features to our tech stack.',
        ...
        {
          quote:
            'Partnerships are all about pushing the boundaries on innovating for the customer through our products. Our partnership with Ligo AI will help us deliver exactly that while we explore new and innovative ways to deploy and bring robust scalability and privacy to our technology stack and eventually the RageFan users and community.',
