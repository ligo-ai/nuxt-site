    ...
    <!-- <v-container>
      ...
      >
        ...
        <v-stack direction="column" align="start" style="max-width: 34rem">
          <app-section-descriptor
            heading="Build"
            description="If you have a great idea for an application to build on the Ligo AI blockchain, sign up here to get access to our developer dashboard and the SDK as soon as it’s available."
          />
          <v-button
...
export default {
  ...
  methods: {
    ...
    onBuild() {
      window.open('https://testnet.ligoai.com', '_blank')
    },
  },
}
</script>
