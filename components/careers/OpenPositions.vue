        ...
        Engineering: [
          {
            ...
            link: 'https://angel.co/company/ligo-ai/jobs/1705690-blockchain-lead-developer',
          },
          {
            title: 'QA Engineer',
            requirements: [
            ...
            link: 'https://angel.co/company/ligo-ai/jobs/1783368-qa-engineer',
          },
          {
            ...
            link: 'https://angel.co/company/ligo-ai/jobs/1829880-senior-golang-engineer',
          },
        ],
        Marketing: [
          {
            ...
            link: 'https://angel.co/company/ligo-ai/jobs/1822884-lead-developer-evangelist',
          },
        ],
        Sales: [
          {
            ...
            requirements: [
              'Lead strategic partnerships with blockchain and crypto projects that are a good fit for Ligo AI',
              'Create innovative proposals for potential partners that drive value for both parties',
            ],
            location: 'Europe | India | USA | Remote',
            compensation: '$40k – $120k | No equity',
            link: 'https://angel.co/company/ligo-ai/jobs/1825008-business-development',
          },
        ],
        Design: [],
      },
