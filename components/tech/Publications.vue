      ...
      <v-stack md-direction="column" justify="space-between" align="center">
        ...
        >
          <app-section-descriptor
            title="Ligo AI Blog"
            heading="Keep up to date with Ligo AI and our research."
            description="We frequently not only write about updates and partnerships at Ligo AI but deep dive into research, share insights through ‘Engineering at Ligo AI and ‘Design at Ligo series, and break down the future of Web 3."
...
export default {
  ...
  methods: {
    openBlog() {
      window.open('https://medium.com/ligo-ai-blog', '_blank')
    },
  },
}
</script>
