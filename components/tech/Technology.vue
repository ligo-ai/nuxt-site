    ...
    <!-- <v-container class="technology-container">
      ...
      <v-stack>
        <app-section-descriptor
          title="Roadmap"
          heading="Ligo AI 2023 Roadmap"
          description="We’re working hard to make privacy and security a de-facto computing standard. Look below to see what we’ve accomplished so far and what we’re working on next. And if you’re inspired, get involved!"
          ...
          >
            <v-chip>
              <v-text color="secondary" line-height="1.5rem" size="1.125rem">
                Files uploaded to Ligo AI are erasure coded into shards.
              </v-text>
            </v-chip>
            <v-chip>
              <v-text color="secondary" line-height="1.5rem" size="1.125rem">
                Each shard is stored on a unique Ligo AI storage node.
              </v-text>
            </v-chip>
            <v-chip>
              <v-text color="secondary" line-height="1.5rem" size="1.125rem">
      ...
      <!-- <v-stack justify="space-between" align="center">
        <v-stack direction="column" md-align="center" class="tech-stack">
          ...
          >
            <v-chip>
              <v-text color="secondary" line-height="1.5rem" size="1.125rem">
                Every file uploaded to Ligo AI is assigned a DID, as per the W3C
                DID spec(link).
              </v-text>
            </v-chip>
            <v-chip>
              <v-text color="secondary" line-height="1.5rem" size="1.125rem">
                DID points to document stored on the public Ligo AI blockchain
